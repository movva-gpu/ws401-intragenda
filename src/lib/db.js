...
export async function createSchemas() {
    ...
    await db.query(`INSERT INTO subjects (name, formation_id) VALUES
        ...
        ('SAÉ 101 - Auditer une communication numérique', 1),
        ('SAÉ 102 - Concevoir une recommandation de communication numérique', 1),
        ('SAÉ 103 - Produire les éléments d''une communication visuelle', 1),
        ('SAÉ 104 - Produire un contenu audio et vidéo', 1),
        ('SAÉ 105 - Produire un site web', 1),
        ('SAÉ 106 - Gérer un projet de communication numérique', 1),
        ('SAÉ PF1 - Portfolio (S1)', 1),
        ('R201 - Anglais', 2),
        ...
        ('SAÉ 201 - Explorer les usages numériques', 2),
        ('SAÉ 202 - Concevoir un produit ou un service et sa communication', 2),
        ('SAÉ 203 - Concevoir un site web avec une source de données', 2),
        ('SAÉ 204 - Construire sa présence en ligne', 2),
        ('SAÉ PF2 - Portfolio (S2)', 2),
